...
import br.com.cookiesoft.pointaccesspmcaapora.rest.AuthService;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            Call<Auth> call = ServiceGenerator.createService(AuthService.class).login(email.toString(),password);
            ...
            call.enqueue(new Callback<Auth>() {
                ...
                public void onResponse(Call<Auth> call, Response<Auth> response) {
                    ...
                    if(response.isSuccessful()){
                        Log.d(TAG,"Token recebido " +response.body().getToken());
                        Preferences.setString(LoginActivity.this,"token_access",response.body().getToken());
                        showProgress(false);
                ...
                public void onFailure(Call<Auth> call, Throwable t) {
                    ...
                    Toast.makeText(LoginActivity.this,error.getError(),Toast.LENGTH_LONG).show();
                    Log.d(TAG,"Error na autenticacao " +t.getMessage());
                }
            });
